...
class TutorialFirstPageViewController: BaseTutorialViewController {
    ...
    @IBAction func secondTutorial(_ sender: Any) {
        
        let websiteURL = URL(string: "https://resume.io/blog/writing-work-experience-on-a-resume")!
